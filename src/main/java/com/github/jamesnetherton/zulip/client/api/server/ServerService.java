...
public class ServerService implements ZulipService {
    ...
    /**
     * Tests the welcome bot custom message.
     *
     * @see                             <a href=
     ...
     * @return                          The {@link TestWelcomeBotCustomMessageApiRequest} builder object
     */
    public TestWelcomeBotCustomMessageApiRequest testWelcomeBotCustomMessage(String welcomeMessageCustomTest) {
        return new TestWelcomeBotCustomMessageApiRequest(this.client, welcomeMessageCustomTest);
    }

    /**
     * Sends E2E mobile push test notifications.
     *
     * @see    <a href="https://zulip.com/api/e2ee-test-notify">https://zulip.com/api/e2ee-test-notify</a>
     *
     * @return The {@link SendE2EMobilePushTestNotification} builder object
     */
    public SendE2EMobilePushTestNotification sendE2EMobilePushTestNotification() {
        return new SendE2EMobilePushTestNotification(this.client);
    }

    /**
     * Registers a E2E mobile push device.
     *
     * @see                              <a href=
     *                                   "https://zulip.com/api/e2ee-test-notify">https://zulip.com/api/e2ee-test-notify</a>
     *
     ...
     * @return                           The {@link RegisterE2EMobilePushDevice} builder object
     */
    public RegisterE2EMobilePushDevice registerE2EMobilePushDevice(
            TokenKind tokenKind,
            int pushAccountId,
