...
image:https://img.shields.io/endpoint?url=https%3A%2F%2Fjamesnetherton.github.io%2Fzulip-java-client%2Fversion.json[title="JavaDoc", link="https://jamesnetherton.github.io/zulip-java-client/0.1.0/index.html"]
...
Create a `Zulip` instance by passing the base URL of the Zulip server, user email address and https://zulip.com/api/api-keys[API key].
[source,java]
----
